...
type OutboxRepository interface {
	Insert(ctx context.Context, tx pgx.Tx, topic string, payload []byte) error
...
func (r *outboxRepository) Insert(ctx context.Context, tx pgx.Tx, topic string, payload []byte) error {
	q := outboxdb.New(tx)
